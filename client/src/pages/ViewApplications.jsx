      ...
      <tbody>
        {viewApplicationsPageData.map((applicant,index)=>(
          <tr key={index} className='text-gray-700'>
            <td className='py-2 px-4 border-b text-center items-center'>{index+1}</td>
            ...
            <td className='py-2 px-4 border-b'>
              <a className='bg-blue-50 px-3 text-blue-400 py-1 rounded inline-flex gap-2 items-center' href= "{applicant.userId.resume}" target='_blank'>Resume <img src={assets.resume_download_icon} alt='' />
              </a>
            </td>
            <td className='py-2 px-4 border-b relative'>
              <div className='relative inline-block text-left group'>
                <button className='text-gray-500 action-button'>...</button>
                <div className="z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 shadow group-hover:block">
